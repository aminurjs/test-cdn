...
(function () {
  ...
  $buuuuu = function () {
    for (
      var a =
          "//www.imatheq.com/imatheq/com/imatheq/scripts/imatheqfunctions.js",
  ...
  org.imatheq.formulaeditor.FormulaEditor = $extend(Object, {
    ...
    redraw: function (a) {
      ...
      0 !== Object.keys(b).length && JSON.stringify(b) !== JSON.stringify({})
        ? ((d =
            "http://www.imatheq.com/imatheq/com/imatheq/math-equation-editor-latex-mathml.html".split(
              "/"
            )),
          (e = $buuuuu()),
          (b =
